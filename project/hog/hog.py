...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    simple_new = simple_update(num_rolls, player_score, opponent_score, dice)
    return sus_points(simple_new)
    # END PROBLEM 4
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_roll_num(score, opponent_score):
        return n
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    for num in range(1,11):
        point = averaged_roll_dice(num, dice)
        if point > max_point:
            max_point = point 
            max_point_num = num
